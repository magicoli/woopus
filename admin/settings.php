...
function WooPUS_register_settings() {
  ...
  WooPUS_settings_add_option( 'WooPUS_product_update', '', array(
    'category' => 'Product updates',
    'name' => __('Synchronize product with plugin package info', 'woopus'),
    'description' => __('Use with caution. This will replace title, excerpt, and content of your product page.', 'woopus'),
    'type' => 'boolean',
    'default' => true,
  ));
